...
## Generated on : Fri May 03 09:42:17 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Jonas/Documents/Master/Model-based\ Development/Bitcraze\ Shared\ Folder/quadcopter_g22/crazyflie-firmware/simulink-model
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/crazyflie -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
SRCS = $(START_DIR)/slprj/ert/crazyflie/crazyflie.c $(START_DIR)/slprj/ert/crazyflie/crazyflieModel.c
...
%.o : $(START_DIR)/slprj/ert/crazyflie/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/crazyflie/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

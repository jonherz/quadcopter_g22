...
void goSouth(int batId)
{
    ...
    while (1)//(uxSemaphoreGetCount(FlagWest) != 0 && !(uxSemaphoreGetCount(FlagWest) != 0 && uxSemaphoreGetCount(FlagNorth) != 0 && uxSemaphoreGetCount(FlagSouth) != 0 && uxSemaphoreGetCount(FlagEast) != 0) )
    {
        if(uxSemaphoreGetCount(FlagWest) == 0 || (uxSemaphoreGetCount(FlagWest) != 0 && uxSemaphoreGetCount(FlagNorth) != 0 && uxSemaphoreGetCount(FlagSouth) != 0 && uxSemaphoreGetCount(FlagEast) != 0))
        {
            break; 
        }
    ...
    if (xSemaphoreTake(semMutex, 100000))
    {   
        xSemaphoreTake(FlagNorth, 1000);
		vPrintf("BAT %d from North enters crossing. BATS waiting, north:%d, east:%d, south:%d, west:%d \n", batId, uxSemaphoreGetCount(FlagNorth), uxSemaphoreGetCount(FlagEast), uxSemaphoreGetCount(FlagSouth), uxSemaphoreGetCount(FlagWest));
...
void goNorth(int batId)
{
    ...
    {   
		...
		vPrintf("BAT %d from South enters crossing. BATS waiting, north:%d, east:%d, south:%d, west:%d \n", batId, uxSemaphoreGetCount(FlagNorth), uxSemaphoreGetCount(FlagEast), uxSemaphoreGetCount(FlagSouth), uxSemaphoreGetCount(FlagWest));
...
void goEast(int batId)
{
    ...
    {   
		...
		vPrintf("BAT %d from West enters crossing. BATS waiting, north:%d, east:%d, south:%d, west:%d \n", batId, uxSemaphoreGetCount(FlagNorth), uxSemaphoreGetCount(FlagEast), uxSemaphoreGetCount(FlagSouth), uxSemaphoreGetCount(FlagWest));
...
void goWest(int batId)
{
    ...
    {   
		...
		vPrintf("BAT %d from East enters crossing. BATS waiting, north:%d, east:%d, south:%d, west:%d \n", batId, uxSemaphoreGetCount(FlagNorth), uxSemaphoreGetCount(FlagEast), uxSemaphoreGetCount(FlagSouth), uxSemaphoreGetCount(FlagWest));
